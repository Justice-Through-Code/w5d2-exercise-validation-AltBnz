...
# Python returns a ValueError if you try to turn a non-number string into an integer.
...
# The tenth item in the list has an index of 9.
...
# Python will return an IndexError if you try to index into a list past the number of items in it.
# Test it out (or google it!) to see which one. Specifically catch that exception in your code.
